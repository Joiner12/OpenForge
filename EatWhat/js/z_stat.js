  ...
  k.prototype = {
    ...
    s: function () {
      try {
        ...
        var c = b.join("&");
        "[object String]" === {}.toString.call(this.v)
          ? this.j(["https://ei.cnzz.com/stat.htm?" + c])
          : this.D || this.u
          ? this.j(["https://ca.cnzz.com/stat.htm?" + c])
          : (this.X && this.j(["https://" + this.X + "/stat.htm?" + c]),
            this.aa && this.j(["https://" + this.aa + "/stat.htm?" + c]));
      } catch (d) {
        g(d, "sD failed");
      }
    },
